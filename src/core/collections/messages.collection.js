export default {
    ...
    actions: {
        async send({ collect }, content) {
            let author = { username: 'dustin', name: 'Dustin', mod: true, color: '#9bb8dc' };
            collect({ id: Math.floor(Math.random() * 100000), content, author, sent: new Date().getTime() }, 'chat-messages');
